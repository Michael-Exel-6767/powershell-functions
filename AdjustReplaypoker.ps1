...
$env:Path="C:\bin\apache-groovy-sdk-3.0.7\groovy-3.0.7\bin;$env:Path"
...
if (Test-Path "C:\Users\exel\.jabba\jabba.ps1") { . "C:\Users\exel\.jabba\jabba.ps1" }
...
# JAVA-Verision
. C:\Users\exel\OneDrive\Dokumente\WindowsPowerShell\SET_JAVA_VERSION.ps1


Set-Window -ProcessName firefox -X 0 -Y 00 -Width 1280 -Height 1024 -Passthru